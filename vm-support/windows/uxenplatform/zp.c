...
static uint8_t sig_nt_KeZeroSinglePage_win10_17134[] = {
    0x66, 0x0f, 0xef, 0xc0, 0xb8, 0x80, 0x00, 0x00,
    0x00, 0xba, 0x20, 0x00, 0x00, 0x00, 0x66, 0x90,
    0x0f, 0x29, 0x01, 0x0f, 0x29, 0x41, 0x10, 0x0f,
    0x29, 0x41, 0x20, 0x0f, 0x29, 0x41, 0x30, 0x48,
    0x03, 0xc8, 0x0f, 0x29, 0x41, 0xc0, 0x0f, 0x29,
    0x41, 0xd0, 0x48, 0xff, 0xca, 0x0f, 0x29, 0x41,
    0xe0, 0x0f, 0x29, 0x41, 0xf0, 0x75, 0xd9, 0xc3
};
static uint8_t sig_nt_KeZeroPages_win10_17134[] = {
    0x66, 0x0f, 0xef, 0xc0, 0xb8, 0x80, 0x00, 0x00,
    0x00, 0x48, 0xc1, 0xea, 0x07, 0x0f, 0x1f, 0x00,
    0x66, 0x0f, 0xe7, 0x01, 0x66, 0x0f, 0xe7, 0x41,
    0x10, 0x66, 0x0f, 0xe7, 0x41, 0x20, 0x66, 0x0f,
    0xe7, 0x41, 0x30, 0x48, 0x03, 0xc8, 0x66, 0x0f,
    0xe7, 0x41, 0xc0, 0x66, 0x0f, 0xe7, 0x41, 0xd0,
    0x48, 0xff, 0xca, 0x66, 0x0f, 0xe7, 0x41, 0xe0,
    0x66, 0x0f, 0xe7, 0x41, 0xf0, 0x75, 0xd1, 0x0f,
    0xae, 0xf8, 0xc3
};
...
static struct fn_sig nt_sig_win10_17134[] = {
    DEF_NT_SIG(KeZeroSinglePage_win10_17134, 16, 1, 0,
               XEN_MEMORY_SET_ZERO_PAGE_NR_GPFN_MODE_single,
               XEN_MEMORY_SET_ZERO_PAGE_GVA_MODE_single,
               XEN_MEMORY_SET_ZERO_PAGE_PROLOGUE_none,
               XEN_MEMORY_SET_ZERO_PAGE_ZERO_THREAD_MODE_none),
    DEF_NT_SIG(KeZeroPages_win10_17134, 16, 1, 0x28,
               XEN_MEMORY_SET_ZERO_PAGE_NR_GPFN_MODE_edx_shift_5,
               XEN_MEMORY_SET_ZERO_PAGE_GVA_MODE_ecx,
               XEN_MEMORY_SET_ZERO_PAGE_PROLOGUE_none,
               XEN_MEMORY_SET_ZERO_PAGE_ZERO_THREAD_MODE_cr3),
